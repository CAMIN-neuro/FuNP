...
if (-e $1/mri/norm.mgz) tkmedit $1 norm.mgz -tcl $RECON_CHECKER_SCRIPTS/snap_tkmedit_FHS_aseg.tcl

#if (-e $1/mri/brainmask.mgz) tkmedit $1 brainmask.mgz -tcl $RECON_CHECKER_SCRIPTS/snap_tkmedit_FHS.tcl
